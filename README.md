...
```bash
git clone https://github.com/saajan/express-mongo-starter.git
...
- [Fork](https://github.com/hagopj13/node-express-mongoose-boilerplate) from https://github.com/hagopj13/node-express-mongoose-boilerplate
